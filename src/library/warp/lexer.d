...
import library.warp.id;
import library.warp.loc;
import library.warp.macros;
import library.warp.omain;
import library.warp.number;
import library.warp.ranges;
import library.warp.skip;
import library.warp.stringlit;
...
struct Lexer(R) if (isInputRange!R)
{
    ...
    library.warp.ranges.BitBucket!E bitbucket = void;
